    ...
    <div className="pt-20 ">
      ...
      <div className="p-6">
        <p>
          ...
          “you”). usasolars.com (“we”, “us”, “our”) adopts this notice to comply
          with the California Consumer Privacy Act of 2018 (“CCPA”), as amended,
          and other California Privacy laws. Any terms defined by the CCPA have
        ...
        <p>
          ...
          Emailing us compliance@usasolars.com Only you or a person registered
          with the California Secretary of State that you authorize to act on
          your behalf, may make a verifiable consumer request related to your
          personal information. You may also make a verifiable consumer request
          on behalf of your minor child. You may only make a verifiable consumer
          request for access or data portability twice within a 12-month period.
          The verifiable consumer request must: Provide sufficient information
          that allows us to reasonably verify you are the person about whom we
          collected personal information or an authorized representative. This
          includes your or the consumer’s:
        </p>
        <ul>
